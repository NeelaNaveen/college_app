...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { department_id: @professor.department_id, email: @professor.email, name: @professor.name, phone: @professor.phone }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { department_id: @professor.department_id, email: @professor.email, name: @professor.name, phone: @professor.phone }
    assert_redirected_to professor_path(assigns(:professor))
  end
